  ...
  : worldmap(worldmap_)
{
  ...
  watertux_sprite = new Surface(datadir +  "/images/worldmap/watertux.png", USE_ALPHA);
  earthtux_sprite = new Surface(datadir +  "/images/worldmap/earthtux.png", USE_ALPHA);
  airtux_sprite = new Surface(datadir +  "/images/worldmap/airtux.png", USE_ALPHA);
...
Tux::~Tux()
{
  ...
  delete watertux_sprite;
  delete earthtux_sprite;
  delete airtux_sprite;
